...
class TaskAlignedAssigner(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            stal_mult (float, optional): Multiplier for the STAL floor size of tiny GT sides
                (1.0 keeps the default stride_val floor; >1 gives tiny faces a larger
                positive-anchor pool).
        """
        super().__init__()
        self.topk = topk
        ...
        self.stal_floor = self.stride_val * stal_mult
        self.eps = eps
    ...
    def select_candidates_in_gts(self, xy_centers, gt_bboxes, mask_gt, eps=1e-9):
        ...
        gt_bboxes_xywh[..., 2:] = torch.where(
            ...
            torch.tensor(self.stal_floor, dtype=gt_bboxes_xywh.dtype, device=gt_bboxes_xywh.device),
            gt_bboxes_xywh[..., 2:],
        )
